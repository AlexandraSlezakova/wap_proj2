window.hjSiteSettings = window.hjSiteSettings || {
    ...
    'features': [
        ...
        'processing.separate_processing_service',
        'settings.billing_v2',
    ...
    220: function (e, t, r) {
            ...
            a = function () {
                function e(t) {
                    var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 10,
                        i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 1000;
                    n(this, e),
                        this.send = t,
                        this.batchSize = r,
                ...
                (r = [
                    ...
                    },
                    {
                        key: 'flush',
                        value: function () {
                            this.buffer.length > 0 && (this.send(this.buffer), this.buffer = [
                            ]),
        ...
        var l,
            ...
            v = function (e) {
                ...
                return d.isDebugEnabled ? u(u(u({
                }, r), e.extraTags), d.genericTags) : r
            },
            m = function (e) {
                if (!l) return !1;
            ...
            j = {
                ...
                count: function (e, t) {
                    ...
                    try {
                        var o = b(n),
                            a = d.loggedMetrics[e],
                            s = 0;
                        if (r) s = (a && a[o] || 0) + (r.value || 1),
                            d.loggedMetrics[e] = u(u({
                            }, a), {
                            }, c({
                            }, o, (null == r ? void 0 : r.flush) ? 0 : s));
                        else s = 1;
                        if (m(r)) {
                            var f = {
                                name: e,
                ...
                time: function () {
                    try {
                        if (!h.browser.hasPerformance) return;
        ...
        window.hj = window.hj || function () {
            ...
            window.hjBootstrap = window.hjBootstrap || function (e, t, r) {
                ...
                var c = function (e, t, r) {
                    window.hjBootstrapCalled = (window.hjBootstrapCalled || [
                    ]).concat(r),
            ...
            window.hjBootstrap('https://script.hotjar.com/', 'modules.e8a3d1a16d3ae98012cf.js', '3410194'),
